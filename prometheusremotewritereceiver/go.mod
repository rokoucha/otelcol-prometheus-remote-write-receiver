...
replace go.opentelemetry.io/collector/cmd/builder v0.0.0 => /home/rokoucha/Projects/github.com/rokoucha/otel-prometheus-remote-write-receiver/prometheusremotewritereceiver
